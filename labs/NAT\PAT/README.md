...
![test-4](https://github.com/andruakadrew/cisco-packet-tracer/blob/main/labs/NAT%5CPAT/images/test4-new.png)


Results: Shows that NAT is active with 6 translation, correct interfaces marked as outside/inside, and a mix of hit/missed packets.
